...
> **Important:** this repository is a **public 9,292-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 9,292 rows · **Live catalog:** 5,621,926 domains
...
- `parts.csv` — public CSV extract (9,292 rows)
- `parts.json` — public JSON extract (9,292 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,292-row public sample | 5,621,926 live domains                           |
...
> Unique Domains. *Available .PARTS One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
